...
public class ShowTime{
        /*
        System.out.println(getTimeStringAutoShort2(new Date(), true));
        System.out.println(new Date());

        刚刚
        Fri Oct 23 10:36:46 CST 2020*/
    ...
    public static String getTimeString(Date dt, String pattern)
    {
        try
        {
            @SuppressLint("SimpleDateFormat") SimpleDateFormat sdf = new SimpleDateFormat(pattern);//"yyyy-MM-dd HH:mm:ss"
